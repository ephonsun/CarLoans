...
<form:form id="signupform" method='POST' action='register' modelAttribute="DisBookUser">
    <table>
      <tr>
        <td>Profile Name:</td>
        <td><input type="text" name="ProfileName" id="profileName" size="25" maxlength="49"></td>
      </tr>
      <tr>
        <td>Age:</td>
        <td><input type="text" name="age" id="user_Age" size="25" maxlength="25"></td>
      </tr>
      <tr>
        <td>E-mail:</td>
        <td><input type="text" name="email" id="Email" size="25" maxlength="49"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>Password:</td>
        <td><input type="password" name="Password" id="disbook_password" size="25" maxlength="49"></td>
      </tr>
      <tr>
    ...
    <label>DisBook User Added Sucessfully!!</label>
  ...
  <p><a href="<%=request.getContextPath()%>/signin">Return to Sign IN</a></p>
</form:form>
<hr>
