...
<form:form id="signupform" method='POST' action='register' modelAttribute="DisBookUser">
    <table>
      ...
      <tr>
        <td>Age:</td>
        <td><input type="text" name="age" value="${DisBookUser.getAge()}" id="user_Age" size="25" maxlength="49"></td>
      </tr>
      <tr>
        <td>E-mail:</td>
      ...
      <tr>
        <td>Username:</td>
        <td><input type="text" name="UserName" value="${DisBookUser.getUserName()}" id="username" size="25" maxlength="49"></td>
      </tr>
      <tr>
        <td>Password:</td>
      ...
      <tr>
        ...
        <td>
        <input type="password" name="confirmpassword" value="${DisBookUser.getPassword()}" id="disbook_passwordConfirm" size="25" maxlength="49"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <label>The email you have chosen already exists in the database!!<br>Did you forgot your password?</label>
